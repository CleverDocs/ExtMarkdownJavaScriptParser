...
class ConcatenationManager {
  ...
  constructor(beforeString, replacerString, afterString, rule, operationNumber, tagsEnabled) {
   ...
   *
   * @param {Boolean} withoutBefore Get replacer concatened with before
   * @return {String} this.beforeString
   */
  get(withoutBefore=false) {

    var prependString = "";
    if( withoutBefore == undefined || withoutBefore == false ){
      prependString = this.beforeString;
    }
