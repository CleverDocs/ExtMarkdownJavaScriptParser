  ...
  processAndSetOutput(eMdElementList) {
    ...
    if (toolKit.isBlank(this.getOutput())) {
      ...
      if ((previousChar == " " && nextChar == " ") || (previousChar == " " && (nextChar == "" || nextChar == "\n"))) {
        eMdElementList[this.getElementNumber() - 1].setOutput( eMdElementList[this.getElementNumber() - 1].getOutput().substring(0, eMdElementList[this.getElementNumber() - 1].getOutput().length-1)  );
      } else if ((previousChar == "" || previousChar == "\n") && nextChar == " ") {
        eMdElementList[this.getElementNumber() + 1].setOutput( eMdElementList[this.getElementNumber() + 1].getOutput().substr(1) );
      }
